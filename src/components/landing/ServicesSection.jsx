...
function ServiceCard({ service, index }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gmo-green/3 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" />
...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="bg-gradient-to-b from-concrete via-light-gray/98 to-light-gray/95 py-24 lg:py-32">
