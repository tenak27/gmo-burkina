...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-obsidian via-obsidian/98 to-black border-t border-white/[0.05] overflow-hidden relative">
      {/* Glow accents */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-12 pb-6 relative z-10">
        ...
        <div className="border-t border-white/[0.05] pt-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="font-body text-[10px] text-white/15">
              Conçu par <span className="text-gmo-green/55 font-semibold">IAM TECHNOLOGY</span> · <span className="text-white/25">Armand Olivier KONATE</span>
            </p>
          </div>
        </div>
      </div>
