...
import { Briefcase, MapPin, Clock, ChevronRight, Star, TrendingUp, Users, Heart, Send, GraduationCap } from "lucide-react";
...
export default function CareersSection() {
  ...
  return (
    <section id="carrieres" className="bg-obsidian overflow-hidden">
