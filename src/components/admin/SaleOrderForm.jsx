  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-8 pb-8 px-4 overflow-y-auto">
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[calc(100vh-4rem)] border border-gray-100 my-auto"
      >
        {/* Header */}
